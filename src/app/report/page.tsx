...
import { Textarea } from "@/components/ui/textarea"; // Using shadcn textarea if available, else standard
import { AlertTriangle, UploadCloud, ShieldCheck, ArrowRight, Lock, Loader2 } from "lucide-react";
            ...
            <div className="container mx-auto px-4 max-w-2xl">
                ...
                <Card className="border-slate-200 shadow-md">
                    <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
                        <div className="flex items-center text-amber-600 text-sm font-medium bg-amber-50 p-3 rounded border border-amber-100">
                            <AlertTriangle className="w-4 h-4 mr-2" />
                            Disclaimer: False reporting is a punishable offense.
                        </div>
                    </CardHeader>
                        ...
                        <CardContent className="space-y-6 pt-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        <option value="whatsapp">WhatsApp / Social Media Scam</option>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="upi" type="text" placeholder="example@upi or https://..." />
                                </div>
                            </div>
